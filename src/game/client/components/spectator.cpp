...
void CSpectator::ConKeySpectator(IConsole::IResult *pResult, void *pUserData)
{
	...
	if(pSelf->m_pClient->m_Snap.m_SpecInfo.m_Active &&
		(IClient::instance()->State() != IClient::STATE_DEMOPLAYBACK || IDemoPlayer::instance()->GetDemoType() == IDemoPlayer::DEMOTYPE_SERVER))
...
{
	IConsole::instance()->Register("+spectate", "", CFGFLAG_CLIENT, ConKeySpectator, this, "Open spectator mode selector");
	IConsole::instance()->Register("spectate", "i", CFGFLAG_CLIENT, ConSpectate, this, "Switch spectator mode");
	IConsole::instance()->Register("spectate_next", "", CFGFLAG_CLIENT, ConSpectateNext, this, "Spectate the next player");
	IConsole::instance()->Register("spectate_previous", "", CFGFLAG_CLIENT, ConSpectatePrevious, this, "Spectate the previous player");
}
...
void CSpectator::OnRender()
{
	...
	IEngineGraphics::instance()->SetColor(0.0f, 0.0f, 0.0f, 0.3f);
	...
	IEngineTextRender::instance()->TextColor(1.0f, 1.0f, 1.0f, Selected?1.0f:0.5f);
	IEngineTextRender::instance()->Text(0, Width/2.0f-240.0f, Height/2.0f-265.0f, FontSize, Localize("Free-View"), -1);
	...
	for(int i = 0, Count = 0; i < MAX_CLIENTS; ++i)
	{
		...
		IEngineTextRender::instance()->TextColor(1.0f, 1.0f, 1.0f, Selected?1.0f:0.5f);
		IEngineTextRender::instance()->Text(0, Width/2.0f+x+50.0f, Height/2.0f+y+5.0f, FontSize, m_pClient->m_aClients[i].m_aName, 220.0f);
