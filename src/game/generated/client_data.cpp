...
static SPRITE x44[] = {
	...
	/* x44[77] */ {  "music",  &x28[4],  1,  1,  1,  1, },
	/* x44[78] */ {  "sorry",  &x28[4],  2,  1,  1,  1, },
	...
	/* x44[85] */ {  "wtf",  &x28[4],  1,  3,  1,  1, },
	/* x44[86] */ {  "eyes",  &x28[4],  2,  3,  1,  1, },
	/* x44[87] */ {  "question",  &x28[4],  3,  3,  1,  1, },
	...
	/* x44[101] */ {  "guibutton_chatoff",  &x28[7],  0,  0,  4,  2, },
	/* x44[102] */ {  "guibutton_chaton",  &x28[7],  4,  0,  4,  2, },
	/* x44[103] */ {  "guibutton_friendadd",  &x28[7],  8,  0,  4,  2, },
	/* x44[104] */ {  "guibutton_friendrem",  &x28[7],  12,  0,  4,  2, },
};
static ANIM_KEYFRAME x4224[] = {
	/* x4224[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static ANIM_KEYFRAME x4231[] = {
	/* x4231[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static ANIM_KEYFRAME x4238[] = {
	/* x4238[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static ANIM_KEYFRAME *x4245 = 0;
static ANIM_KEYFRAME *x4269 = 0;
static ANIM_KEYFRAME x4276[] = {
	/* x4276[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4283[] = {
	/* x4283[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME *x4290 = 0;
static ANIM_KEYFRAME *x4309 = 0;
static ANIM_KEYFRAME x4316[] = {
	/* x4316[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME x4323[] = {
	/* x4323[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME *x4330 = 0;
static ANIM_KEYFRAME x4349[] = {
	/* x4349[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4349[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4349[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4349[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4349[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4349[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4356[] = {
	/* x4356[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4356[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4356[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4356[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4356[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4356[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4363[] = {
	/* x4363[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4363[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4363[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4363[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4363[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4363[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static ANIM_KEYFRAME *x4370 = 0;
static ANIM_KEYFRAME *x4469 = 0;
static ANIM_KEYFRAME *x4476 = 0;
static ANIM_KEYFRAME *x4483 = 0;
static ANIM_KEYFRAME x4490[] = {
	/* x4490[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4490[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4490[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4490[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4490[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME *x4524 = 0;
static ANIM_KEYFRAME *x4531 = 0;
static ANIM_KEYFRAME *x4538 = 0;
static ANIM_KEYFRAME x4545[] = {
	/* x4545[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4545[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4545[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4545[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4545[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4545[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static ANIMATION x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4224, },  /* x75[0].back_foot */ {  1,x4231, },  /* x75[0].front_foot */ {  1,x4238, },  /* x75[0].attach */ {  0,x4245, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4269, },  /* x75[1].back_foot */ {  1,x4276, },  /* x75[1].front_foot */ {  1,x4283, },  /* x75[1].attach */ {  0,x4290, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4309, },  /* x75[2].back_foot */ {  1,x4316, },  /* x75[2].front_foot */ {  1,x4323, },  /* x75[2].attach */ {  0,x4330, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4349, },  /* x75[3].back_foot */ {  6,x4356, },  /* x75[3].front_foot */ {  6,x4363, },  /* x75[3].attach */ {  0,x4370, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4469, },  /* x75[4].back_foot */ {  0,x4476, },  /* x75[4].front_foot */ {  0,x4483, },  /* x75[4].attach */ {  5,x4490, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4524, },  /* x75[5].back_foot */ {  0,x4531, },  /* x75[5].front_foot */ {  0,x4538, },  /* x75[5].attach */ {  6,x4545, }, },
};
static SPRITE* *x4702 = 0;
static SPRITE* x4839[] = {
	&x44[28],
	&x44[29],
	&x44[30],
...
static SPRITE* *x5209 = 0;
static SPRITE* *x5346 = 0;
static SPRITE* x5483[] = {
	&x44[51],
	&x44[52],
	&x44[53],
...
static WEAPONSPEC x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[40],  &x44[41],  &x44[42],  0,x4702,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[25],  &x44[26],  &x44[27],  3,x4839,  64,  125,  10,  500,  1,  32.000000,  -4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[31],  &x44[32],  &x44[33],  3,x5024,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[37],  &x44[38],  &x44[39],  0,x5209,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[46],  &x44[47],  &x44[48],  0,x5346,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[43],  &x44[44],  &x44[45],  3,x5483,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
