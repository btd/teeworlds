...
static SOUND x2458[] = {
	/* x2458[0] */ {  0,  "audio/sfx_ctf_drop.wv", },
};
static SOUND x2468[] = {
	/* x2468[0] */ {  0,  "audio/sfx_ctf_rtn.wv", },
};
static SOUND x2478[] = {
	/* x2478[0] */ {  0,  "audio/sfx_ctf_grab_pl.wv", },
};
static SOUND x2488[] = {
	/* x2488[0] */ {  0,  "audio/sfx_ctf_grab_en.wv", },
};
static SOUND x2498[] = {
	/* x2498[0] */ {  0,  "audio/sfx_ctf_cap_pl.wv", },
};
static SOUNDSET x9[] = {
	...
	/* x9[34] */ {  "ctf_drop",  1,x2458,  -1, },
	/* x9[35] */ {  "ctf_return",  1,x2468,  -1, },
	/* x9[36] */ {  "ctf_grab_pl",  1,x2478,  -1, },
	/* x9[37] */ {  "ctf_grab_en",  1,x2488,  -1, },
	/* x9[38] */ {  "ctf_capture",  1,x2498,  -1, },
};
static IMAGE x14[] = {
	/* x14[0] */ {  "null",  "",  -1, },
...
static SPRITE x44[] = {
	...
	/* x44[43] */ {  "weapon_ninja_body",  &x28[1],  2,  10,  8,  2, },
	...
	/* x44[57] */ {  "pickup_ninja",  &x28[1],  2,  10,  8,  2, },
	...
	/* x44[91] */ {  "demobutton_play",  &x28[5],  0,  0,  1,  1, },
	/* x44[92] */ {  "demobutton_pause",  &x28[5],  1,  0,  1,  1, },
	/* x44[93] */ {  "demobutton_stop",  &x28[5],  2,  0,  1,  1, },
	/* x44[94] */ {  "demobutton_slower",  &x28[5],  3,  0,  1,  1, },
	/* x44[95] */ {  "demobutton_faster",  &x28[5],  4,  0,  1,  1, },
	/* x44[96] */ {  "file_demo1",  &x28[6],  0,  0,  1,  1, },
	/* x44[97] */ {  "file_demo2",  &x28[6],  1,  0,  1,  1, },
	/* x44[98] */ {  "file_folder",  &x28[6],  2,  0,  1,  1, },
	/* x44[99] */ {  "file_map1",  &x28[6],  5,  0,  1,  1, },
	/* x44[100] */ {  "file_map2",  &x28[6],  6,  0,  1,  1, },
};
static ANIM_KEYFRAME x4142[] = {
	/* x4142[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static ANIM_KEYFRAME x4149[] = {
	/* x4149[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static ANIM_KEYFRAME x4156[] = {
	/* x4156[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static ANIM_KEYFRAME *x4163 = 0;
static ANIM_KEYFRAME *x4187 = 0;
static ANIM_KEYFRAME x4194[] = {
	/* x4194[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4201[] = {
	/* x4201[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME *x4208 = 0;
static ANIM_KEYFRAME *x4227 = 0;
static ANIM_KEYFRAME x4234[] = {
	/* x4234[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME x4241[] = {
	/* x4241[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME *x4248 = 0;
static ANIM_KEYFRAME x4267[] = {
	/* x4267[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4267[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4267[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4267[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4267[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4267[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4274[] = {
	/* x4274[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4274[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4274[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4274[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4274[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4274[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static ANIM_KEYFRAME x4281[] = {
	/* x4281[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4281[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4281[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4281[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4281[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4281[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static ANIM_KEYFRAME *x4288 = 0;
static ANIM_KEYFRAME *x4387 = 0;
static ANIM_KEYFRAME *x4394 = 0;
static ANIM_KEYFRAME *x4401 = 0;
static ANIM_KEYFRAME x4408[] = {
	/* x4408[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4408[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4408[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4408[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4408[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static ANIM_KEYFRAME *x4442 = 0;
static ANIM_KEYFRAME *x4449 = 0;
static ANIM_KEYFRAME *x4456 = 0;
static ANIM_KEYFRAME x4463[] = {
	/* x4463[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4463[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4463[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4463[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4463[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4463[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static ANIMATION x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4142, },  /* x75[0].back_foot */ {  1,x4149, },  /* x75[0].front_foot */ {  1,x4156, },  /* x75[0].attach */ {  0,x4163, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4187, },  /* x75[1].back_foot */ {  1,x4194, },  /* x75[1].front_foot */ {  1,x4201, },  /* x75[1].attach */ {  0,x4208, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4227, },  /* x75[2].back_foot */ {  1,x4234, },  /* x75[2].front_foot */ {  1,x4241, },  /* x75[2].attach */ {  0,x4248, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4267, },  /* x75[3].back_foot */ {  6,x4274, },  /* x75[3].front_foot */ {  6,x4281, },  /* x75[3].attach */ {  0,x4288, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4387, },  /* x75[4].back_foot */ {  0,x4394, },  /* x75[4].front_foot */ {  0,x4401, },  /* x75[4].attach */ {  5,x4408, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4442, },  /* x75[5].back_foot */ {  0,x4449, },  /* x75[5].front_foot */ {  0,x4456, },  /* x75[5].attach */ {  6,x4463, }, },
};
static SPRITE* *x4620 = 0;
static SPRITE* x4757[] = {
	&x44[28],
	&x44[29],
	&x44[30],
...
static SPRITE* *x5127 = 0;
static SPRITE* *x5264 = 0;
static SPRITE* x5401[] = {
	&x44[51],
	&x44[52],
	&x44[53],
...
static WEAPONSPEC x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[40],  &x44[41],  &x44[42],  0,x4620,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[25],  &x44[26],  &x44[27],  3,x4757,  64,  125,  10,  500,  1,  32.000000,  -4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[31],  &x44[32],  &x44[33],  3,x4942,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[37],  &x44[38],  &x44[39],  0,x5127,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[46],  &x44[47],  &x44[48],  0,x5264,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[43],  &x44[44],  &x44[45],  3,x5401,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
